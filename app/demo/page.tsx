    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <header className="mb-8 text-center">
          <h1 className="text-3xl font-bold mb-2">Sidenotes Demo</h1>
          <p className="text-muted-foreground">
            Select any text below to add a sidenote. Your highlights will be saved and positioned using the sidenotes library.
          </p>
        </header>

        <SidenoteManager pageUrl={pageUrl} docId="demo-article">
          <div className="prose prose-lg dark:prose-invert mx-auto">
            ...
            <p>
              As remote work continues to become more prevalent, the demand for sophisticated
              collaborative editing tools will only increase. Organizations that invest in building
              robust, user-friendly annotation systems will be better positioned to support their
              distributed teams and maintain productivity in an increasingly digital workplace.
            </p>
          </div>
        </SidenoteManager>
      </div>
